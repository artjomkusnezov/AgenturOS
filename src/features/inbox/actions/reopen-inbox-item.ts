...
import { reopenInboxItemForCurrentUser } from '@/features/inbox/repositories/inbox-repository'
...
export async function reopenInboxItemAction(
  ...
  const result = await reopenInboxItemForCurrentUser(itemId)
