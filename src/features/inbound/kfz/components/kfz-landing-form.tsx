      ...
      {step === 2 ? (
        <div className="space-y-4">
          ...
          <p className="rounded-xl bg-[#f3f7fb] px-3.5 py-3 text-xs leading-relaxed text-[#4a5565]">
            ...
            <a href={KFZ_LANDING_PRIVACY_URL} target="_blank" rel="noreferrer" className="font-semibold text-[#0050aa] underline-offset-2 hover:underline">
              Datenschutz
            </a>
          </p>
        </div>
          ...
          <Alert variant="error">
            ...
            {serverError ? (
              <p className="mt-2 text-sm">
                ...
                <a className="font-medium underline-offset-2 hover:underline" href={`tel:${KFZ_LANDING_CONTACT_PHONE_E164}`}>
                  {KFZ_LANDING_CONTACT_PHONE}
                </a>
                .
              </p>
