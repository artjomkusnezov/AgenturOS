    ...
    <div lang="de" className="min-h-full flex-1 overflow-x-hidden bg-white text-[#171717]">
      <header className="border-b border-[#d9e1ea] bg-white">
        <div className="mx-auto flex min-h-20 w-full max-w-7xl items-center justify-between gap-4 px-5 sm:px-8">
          <a
            href={KFZ_LANDING_AGENCY_URL}
            target="_blank"
            rel="noreferrer"
            aria-label="Allianz Kusnezov auf allianz.de"
          >
            <Image
              src="/kfz/allianz-logo.svg"
              width={154}
              height={40}
              alt="Allianz"
              priority
              className="h-auto w-[128px] sm:w-[154px]"
            />
          </a>
          <div className="flex items-center gap-2 sm:gap-3">
            <a
              href={`tel:${KFZ_LANDING_CONTACT_PHONE_E164}`}
              className="hidden min-h-11 items-center gap-2 rounded-full border border-[#c8d4e2] px-4 text-sm font-semibold text-[#003781] transition hover:border-[#003781] hover:bg-[#f2f6fa] sm:inline-flex"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex min-h-11 items-center gap-2 rounded-full bg-[#007a50] px-4 text-sm font-semibold text-white transition hover:bg-[#006543]"
            >
      ...
      <main>
        <section className="px-4 pt-4 sm:px-6 sm:pt-6" aria-labelledby="kfz-hero-title">
          <div className="relative mx-auto min-h-[590px] max-w-7xl overflow-hidden rounded-[1.75rem] bg-[#002f6c] sm:min-h-[620px] sm:rounded-[2.25rem]">
            <Image
              src="/kfz/lengerich-roemer-hero.webp"
              alt="Der Römer in Lengerich mit Kirche und einem Familienauto"
              fill
              priority
            ...
            <div className="relative z-10 flex min-h-[590px] max-w-2xl flex-col justify-center px-6 py-14 text-white sm:min-h-[620px] sm:px-12 lg:px-16">
              ...
              <h1
                id="kfz-hero-title"
                className="max-w-xl text-4xl font-semibold leading-[1.06] tracking-[-0.035em] sm:text-6xl"
              >
                Kfz-Versicherung, persönlich geprüft.
              </h1>
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/90 sm:text-xl">
                Kein anonymer Vergleich. Artjom und Vera prüfen Ihre Anfrage persönlich und
                melden sich mit einer passenden Einschätzung.
              </p>
              <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                <a
                  href="#kfz-anfrage"
                  className="inline-flex min-h-14 w-full items-center justify-center gap-2 rounded-xl bg-white px-6 text-base font-semibold text-[#003781] shadow-lg shadow-black/10 transition hover:bg-[#eef5ff] sm:w-auto"
                >
                  Kfz-Check starten
        ...
        <section
          className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-px px-5 py-5 sm:grid-cols-3 sm:px-8 sm:py-7"
          aria-label="Ihre Vorteile"
        >
          <TrustItem
            icon={<ShieldCheck />}
            title="Persönlich geprüft"
            text="Keine automatische Tarifausgabe"
          />
          <TrustItem
            icon={<Clock3 />}
            title="Schnelle Rückmeldung"
            text="In der Regel innerhalb eines Werktags"
          />
          <TrustItem
            icon={<Languages />}
            title="Drei Sprachen"
            text="Deutsch, Russisch und Englisch"
          />
        </section>
        ...
        <section className="px-5 py-16 sm:px-8 sm:py-24" aria-labelledby="team-heading">
          <div className="mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[1fr_.9fr]">
            <div>
              ...
              >
                Hier prüfen Menschen, keine Maschine.
              </h2>
              <p className="mt-5 max-w-2xl text-lg leading-relaxed text-[#4a5565]">
                Ihre Anfrage landet direkt bei uns in Lengerich. Wir schauen auf Ihre
                Situation und melden uns auf dem Weg, den Sie ausgewählt haben.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Person
                  image="/kfz/artjom-kusnezov.png"
                  name="Artjom Kusnezov"
                  languages="Deutsch · English · Русский"
                />
                <Person
                  image="/kfz/vera-kusnezov.png"
                  name="Vera Kusnezov"
                  languages="Deutsch · Русский · English"
                />
              </div>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-[1.75rem] border border-[#d7e0ea] bg-white p-7 shadow-[0_16px_45px_rgba(0,55,129,.08)] transition hover:-translate-y-0.5 hover:shadow-[0_20px_55px_rgba(0,55,129,.12)]"
            >
              <p className="text-sm font-semibold text-[#4a5565]">Google Bewertungen</p>
              <div className="mt-4 flex items-end gap-3">
                <strong className="text-5xl font-semibold tracking-tight">4,9</strong>
                <span className="pb-1 text-sm text-[#4a5565]">von 5</span>
              </div>
              <div className="mt-3 flex gap-1 text-[#f5b700]" aria-label="5 von 5 Sternen">
                {[0, 1, 2, 3, 4].map((star) => (
              ...
              <p className="mt-2 text-sm text-[#5b6675]">
                Bewertungen auf dem offiziellen Agenturprofil ansehen
              </p>
            </a>
          </div>
        </section>
        ...
        <section
          className="bg-[#eef4fb] px-5 py-16 sm:px-8 sm:py-24"
        ...
        >
          <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[.65fr_1fr]">
            <div>
              ...
              <p className="mt-5 text-lg leading-relaxed text-[#4a5565]">
                Die wichtigsten Antworten, bevor Sie Ihre Anfrage senden.
              </p>
            </div>
            <div className="divide-y divide-[#cbd8e6] border-y border-[#cbd8e6]">
              <Faq question="Kostet die Prüfung etwas?">
                Nein. Die erste Prüfung Ihrer Anfrage ist kostenlos und unverbindlich.
              </Faq>
              <Faq question="Muss ich anschließend wechseln?">
                Nein. Aus der Anfrage entsteht keine Verpflichtung zum Abschluss oder Wechsel.
              </Faq>
              <Faq question="Wann erhalte ich eine Rückmeldung?">
                Wir melden uns in der Regel innerhalb eines Werktags per WhatsApp, Telefon
                oder E-Mail.
              </Faq>
        ...
        <section className="bg-[#003781] px-5 py-14 text-white sm:px-8">
          <div className="mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-7 sm:flex-row sm:items-center">
            <div>
              <p className="text-2xl font-semibold tracking-tight">Lieber direkt sprechen?</p>
              <p className="mt-2 text-white/80">Artjom und Vera sind in Lengerich für Sie da.</p>
            </div>
            <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
              <a
                href={`tel:${KFZ_LANDING_CONTACT_PHONE_E164}`}
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-white px-5 font-semibold text-[#003781]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-white/50 px-5 font-semibold text-white hover:bg-white/10"
              >
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-7 md:grid-cols-[1fr_auto] md:items-end">
          <div>
            <p className="font-semibold text-white">
              {KFZ_LANDING_AGENCY_NAME} · Artjom Kusnezov Hauptvertretung
            </p>
            <p className="mt-2">{KFZ_LANDING_ADDRESS}</p>
            <p className="mt-1">
              <a href={`mailto:${KFZ_LANDING_CONTACT_EMAIL}`} className="hover:text-white">
                {KFZ_LANDING_CONTACT_EMAIL}
              </a>
            </p>
          </div>
...
function TrustItem({
  ...
  return (
    <div className="flex items-center gap-3 border-b border-[#d9e1ea] py-4 last:border-b-0 sm:border-b-0 sm:border-r sm:px-6 sm:first:pl-0 sm:last:border-r-0">
      <span className="text-[#0050aa] [&>svg]:h-6 [&>svg]:w-6" aria-hidden="true">
        {icon}
      </span>
      <div>
        <h2 className="font-semibold">{title}</h2>
        <p className="mt-0.5 text-sm text-[#5b6675]">{text}</p>
      </div>
    </div>
  )
}
...
function CheckItem({ children }: { children: ReactNode }) {
  return (
    <li className="flex items-center gap-3">
      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#dcecff] text-[#0050aa]">
...
function Person({
  ...
  return (
    <div className="flex min-w-[250px] items-center gap-4 rounded-2xl bg-[#f3f6f9] p-3 pr-5">
      <Image
        src={image}
        alt={name}
        width={72}
      ...
      <div>
        ...
        <p className="mt-1 text-xs leading-relaxed text-[#5b6675]">{languages}</p>
      </div>
    </div>
  )
}
  ...
  return (
    <details className="group py-5">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-5 text-lg font-semibold">
        <span>{question}</span>
        <span
          className="text-2xl font-light text-[#0050aa] transition group-open:rotate-45"
          aria-hidden="true"
        >
          +
        </span>
      </summary>
      <p className="mt-3 max-w-2xl pr-10 leading-relaxed text-[#4a5565]">{children}</p>
    </details>
  )
}
