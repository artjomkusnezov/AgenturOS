  ...
  return (
    <div className="border-t border-zinc-200/70 pt-4">
      <button
        ...
        onClick={onClick}
        disabled={disabled}
        className="w-full rounded-lg border border-zinc-200/80 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 transition-colors duration-150 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-60"
      >
